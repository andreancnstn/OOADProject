...
public class OrderQueueView extends JFrame implements ActionListener {
	...
	public OrderQueueView() throws HeadlessException {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == cookFoodBtn) {
			
			int row = table.getSelectedRow();
			String orderidd = "" + table.getValueAt(row, 0);
			int ord = Integer.parseInt(orderidd);
			//mengupdate status yg diklik to 'cooked'
			oh.updateStatus(ord, "cooked");
			displayMsg("Order succesfuully cooked!");
